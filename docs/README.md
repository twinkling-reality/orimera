...
| [atlas-world-customization-contract.md](atlas-world-customization-contract.md) | Protected topology, appearance and structural proposal lifecycles, profile compatibility, failures, and safe fallbacks | DECISION; backend foundation implemented |
