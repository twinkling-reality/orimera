...
Status: **implemented and contract-tested; no real dense capture run**.
...
No consented dense OGC-1 capture group or digest-pinned COLMAP runtime was found locally, so Phase
3B has not passed its real reconstruction gate and no real pose artifact or quality result is
claimed.
