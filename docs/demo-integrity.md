...
| 8 | A visitor opens it on a phone | The World Index is the default entry point on touch devices. Atlas traversal is not offered there and is not implied | Partly, same as above |
